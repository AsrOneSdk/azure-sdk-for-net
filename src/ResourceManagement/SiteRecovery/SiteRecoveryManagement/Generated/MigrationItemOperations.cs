...
namespace Microsoft.Azure.Management.SiteRecovery
{
    ...
    internal partial class MigrationItemOperations : IServiceOperations<SiteRecoveryManagementClient>, IMigrationItemOperations
    {
        ...
        /// </returns>
        public async Task<LongRunningOperationResponse> BeginCompleteMigrationAsync(string fabricName, string protectionContainerName, string migrationItemName, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            // Validate
            if (fabricName == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                TracingAdapter.Enter(invocationId, this, "BeginCompleteMigrationAsync", tracingParameters);
            }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public async Task<LongRunningOperationResponse> BeginDisableMigrationAsync(string fabricName, string protectionContainerName, string migrationItemName, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            // Validate
            if (fabricName == null)
            {
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public async Task<LongRunningOperationResponse> BeginPurgeMigrationAsync(string fabricName, string protectionContainerName, string migrationItemName, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            // Validate
            if (fabricName == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                tracingParameters.Add("migrationItemName", migrationItemName);
                tracingParameters.Add("customRequestHeaders", customRequestHeaders);
                TracingAdapter.Enter(invocationId, this, "BeginPurgeMigrationAsync", tracingParameters);
            }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public async Task<LongRunningOperationResponse> CompleteMigrationAsync(string fabricName, string protectionContainerName, string migrationItemName, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            ...
            if (shouldTrace)
            {
                ...
                tracingParameters.Add("migrationItemName", migrationItemName);
                tracingParameters.Add("customRequestHeaders", customRequestHeaders);
                TracingAdapter.Enter(invocationId, this, "CompleteMigrationAsync", tracingParameters);
            }
            
            cancellationToken.ThrowIfCancellationRequested();
            LongRunningOperationResponse response = await client.MigrationItem.BeginCompleteMigrationAsync(fabricName, protectionContainerName, migrationItemName, customRequestHeaders, cancellationToken).ConfigureAwait(false);
            if (response.Status == OperationStatus.Succeeded)
            {
                return response;
            }
            cancellationToken.ThrowIfCancellationRequested();
            MigrationItemOperationResponse result = await client.MigrationItem.GetCompleteMigrationStatusAsync(response.Location, cancellationToken).ConfigureAwait(false);
            ...
            while (result.Status == OperationStatus.InProgress)
            {
                ...
                cancellationToken.ThrowIfCancellationRequested();
                result = await client.MigrationItem.GetCompleteMigrationStatusAsync(response.Location, cancellationToken).ConfigureAwait(false);
                delayInSeconds = 30;
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public async Task<LongRunningOperationResponse> DisableMigrationAsync(string fabricName, string protectionContainerName, string migrationItemName, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            SiteRecoveryManagementClient client = this.Client;
            bool shouldTrace = TracingAdapter.IsEnabled;
            string invocationId = null;
            ...
            cancellationToken.ThrowIfCancellationRequested();
            LongRunningOperationResponse response = await client.MigrationItem.BeginDisableMigrationAsync(fabricName, protectionContainerName, migrationItemName, customRequestHeaders, cancellationToken).ConfigureAwait(false);
            if (response.Status == OperationStatus.Succeeded)
            {
                return response;
            }
        ...
        /// </returns>
        public async Task<MigrationItemOperationResponse> GetCompleteMigrationStatusAsync(string operationStatusLink, CancellationToken cancellationToken)
        {
            // Validate
            ...
            if (shouldTrace)
            {
                ...
                TracingAdapter.Enter(invocationId, this, "GetCompleteMigrationStatusAsync", tracingParameters);
            }
        ...
        /// Service response for migration items operation.
        /// </returns>
        public async Task<MigrationItemOperationResponse> GetPurgeMigrationStatusAsync(string operationStatusLink, CancellationToken cancellationToken)
        {
            // Validate
            if (operationStatusLink == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("operationStatusLink", operationStatusLink);
                TracingAdapter.Enter(invocationId, this, "GetPurgeMigrationStatusAsync", tracingParameters);
            }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public async Task<LongRunningOperationResponse> PurgeMigrationAsync(string fabricName, string protectionContainerName, string migrationItemName, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            SiteRecoveryManagementClient client = this.Client;
            bool shouldTrace = TracingAdapter.IsEnabled;
            string invocationId = null;
            if (shouldTrace)
            {
                ...
                tracingParameters.Add("migrationItemName", migrationItemName);
                tracingParameters.Add("customRequestHeaders", customRequestHeaders);
                TracingAdapter.Enter(invocationId, this, "PurgeMigrationAsync", tracingParameters);
            }
            
            cancellationToken.ThrowIfCancellationRequested();
            LongRunningOperationResponse response = await client.MigrationItem.BeginPurgeMigrationAsync(fabricName, protectionContainerName, migrationItemName, customRequestHeaders, cancellationToken).ConfigureAwait(false);
            if (response.Status == OperationStatus.Succeeded)
            {
                return response;
            }
            cancellationToken.ThrowIfCancellationRequested();
            MigrationItemOperationResponse result = await client.MigrationItem.GetPurgeMigrationStatusAsync(response.Location, cancellationToken).ConfigureAwait(false);
            int delayInSeconds = 30;
            if (client.LongRunningOperationInitialTimeout >= 0)
            {
                delayInSeconds = client.LongRunningOperationInitialTimeout;
            ...
            while (result.Status == OperationStatus.InProgress)
            {
                ...
                await TaskEx.Delay(delayInSeconds * 1000, cancellationToken).ConfigureAwait(false);
                cancellationToken.ThrowIfCancellationRequested();
                result = await client.MigrationItem.GetPurgeMigrationStatusAsync(response.Location, cancellationToken).ConfigureAwait(false);
                delayInSeconds = 30;
                if (client.LongRunningOperationRetryTimeout >= 0)
                {
                    delayInSeconds = client.LongRunningOperationRetryTimeout;
