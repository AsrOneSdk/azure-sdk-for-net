                            ...
                            if (propertiesValue != null && propertiesValue.Type != JTokenType.Null)
                            {
                                ...
                                if (customDetailsValue != null && customDetailsValue.Type != JTokenType.Null)
                                {
                                    ...
                                    if (typeName == "VMwareVirtualMachine")
                                    {
                                        ...
                                        JToken validationErrorsArray = customDetailsValue["validationErrors"];
                                        if (validationErrorsArray != null && validationErrorsArray.Type != JTokenType.Null)
                                        {
                                            foreach (JToken validationErrorsValue in ((JArray)validationErrorsArray))
                                            {
                                                ...
                                                JToken errorCategoryValue = validationErrorsValue["errorCategory"];
                                                ...
                                                JToken summaryMessageValue = validationErrorsValue["summaryMessage"];
                                                ...
                                                JToken innerHealthErrorsArray = validationErrorsValue["innerHealthErrors"];
