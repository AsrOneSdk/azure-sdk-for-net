...
namespace Microsoft.Azure.Management.SiteRecovery
{
    ...
    internal partial class ProtectionContainerOperations : IServiceOperations<SiteRecoveryManagementClient>, IProtectionContainerOperations
    {
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public async Task<LongRunningOperationResponse> BeginSwitchProtectionAsync(string fabricName, string protectionContainerName, SwitchProtectionInput input, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            // Validate
            if (fabricName == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                tracingParameters.Add("input", input);
                tracingParameters.Add("customRequestHeaders", customRequestHeaders);
                TracingAdapter.Enter(invocationId, this, "BeginSwitchProtectionAsync", tracingParameters);
            }
            ...
            try
            {
                ...
                JObject switchProtectionInputValue = new JObject();
                requestDoc = switchProtectionInputValue;
                
                if (input.Properties != null)
                {
                    JObject propertiesValue = new JObject();
                    switchProtectionInputValue["properties"] = propertiesValue;
                    
                    if (input.Properties.ReplicationProtectedItemName != null)
                    {
                        propertiesValue["replicationProtectedItemName"] = input.Properties.ReplicationProtectedItemName;
                    }
                    ...
                    if (input.Properties.ProviderSpecificDetails != null)
                    {
                        ...
                        if (input.Properties.ProviderSpecificDetails is A2ASwitchProtectionInput)
                        {
                            providerSpecificDetailsValue["instanceType"] = "A2A";
                            A2ASwitchProtectionInput derived = ((A2ASwitchProtectionInput)input.Properties.ProviderSpecificDetails);
                            
                            if (derived.RecoveryContainerId != null)
                            {
                                providerSpecificDetailsValue["recoveryContainerId"] = derived.RecoveryContainerId;
                            }
                            
                            if (derived.VmDisks != null)
                            {
                                if (derived.VmDisks is ILazyCollection == false || ((ILazyCollection)derived.VmDisks).IsInitialized)
                                {
                                    JArray vmDisksArray = new JArray();
                                    foreach (A2AVmDiskInputDetails vmDisksItem in derived.VmDisks)
                                    {
                                        JObject a2AVmDiskInputDetailsValue = new JObject();
                                        vmDisksArray.Add(a2AVmDiskInputDetailsValue);
                                        
                                        if (vmDisksItem.DiskUri != null)
                                        {
                                            a2AVmDiskInputDetailsValue["diskUri"] = vmDisksItem.DiskUri;
                                        }
                                        
                                        if (vmDisksItem.RecoveryAzureStorageAccountId != null)
                                        {
                                            a2AVmDiskInputDetailsValue["recoveryAzureStorageAccountId"] = vmDisksItem.RecoveryAzureStorageAccountId;
                                        }
                                        
                                        if (vmDisksItem.PrimaryStagingAzureStorageAccountId != null)
                                        {
                            ...
                            if (derived.RecoveryResourceGroupId != null)
                            {
                                providerSpecificDetailsValue["recoveryResourceGroupId"] = derived.RecoveryResourceGroupId;
                            }
                            
                            if (derived.RecoveryCloudServiceId != null)
                            {
                                providerSpecificDetailsValue["recoveryCloudServiceId"] = derived.RecoveryCloudServiceId;
                            }
        ...
        /// container.
        /// </returns>
        public async Task<ContainerOperationResponse> GetSwitchProtectionStatusAsync(string operationStatusLink, CancellationToken cancellationToken)
        {
            // Validate
            if (operationStatusLink == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("operationStatusLink", operationStatusLink);
                TracingAdapter.Enter(invocationId, this, "GetSwitchProtectionStatusAsync", tracingParameters);
            }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public async Task<LongRunningOperationResponse> SwitchProtectionAsync(string fabricName, string protectionContainerName, SwitchProtectionInput input, CustomRequestHeaders customRequestHeaders, CancellationToken cancellationToken)
        {
            SiteRecoveryManagementClient client = this.Client;
            bool shouldTrace = TracingAdapter.IsEnabled;
            string invocationId = null;
            if (shouldTrace)
            {
                ...
                tracingParameters.Add("input", input);
                tracingParameters.Add("customRequestHeaders", customRequestHeaders);
                TracingAdapter.Enter(invocationId, this, "SwitchProtectionAsync", tracingParameters);
            }
            
            cancellationToken.ThrowIfCancellationRequested();
            LongRunningOperationResponse response = await client.ProtectionContainer.BeginSwitchProtectionAsync(fabricName, protectionContainerName, input, customRequestHeaders, cancellationToken).ConfigureAwait(false);
            if (response.Status == OperationStatus.Succeeded)
            {
                return response;
            }
            cancellationToken.ThrowIfCancellationRequested();
            ContainerOperationResponse result = await client.ProtectionContainer.GetSwitchProtectionStatusAsync(response.Location, cancellationToken).ConfigureAwait(false);
            int delayInSeconds = 30;
            if (client.LongRunningOperationInitialTimeout >= 0)
            {
                delayInSeconds = client.LongRunningOperationInitialTimeout;
            ...
            while (result.Status == OperationStatus.InProgress)
            {
                ...
                await TaskEx.Delay(delayInSeconds * 1000, cancellationToken).ConfigureAwait(false);
                cancellationToken.ThrowIfCancellationRequested();
                result = await client.ProtectionContainer.GetSwitchProtectionStatusAsync(response.Location, cancellationToken).ConfigureAwait(false);
                delayInSeconds = 30;
                if (client.LongRunningOperationRetryTimeout >= 0)
                {
                    delayInSeconds = client.LongRunningOperationRetryTimeout;
