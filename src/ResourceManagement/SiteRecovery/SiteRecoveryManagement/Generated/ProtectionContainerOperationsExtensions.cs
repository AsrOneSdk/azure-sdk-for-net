...
namespace Microsoft.Azure.Management.SiteRecovery
{
    public static partial class ProtectionContainerOperationsExtensions
    {
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public static LongRunningOperationResponse BeginPurgeProtection(this IProtectionContainerOperations operations, string fabricName, string protectionContainerName, PurgeProtectionInput input, CustomRequestHeaders customRequestHeaders)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IProtectionContainerOperations)s).BeginPurgeProtectionAsync(fabricName, protectionContainerName, input, customRequestHeaders);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public static Task<LongRunningOperationResponse> BeginPurgeProtectionAsync(this IProtectionContainerOperations operations, string fabricName, string protectionContainerName, PurgeProtectionInput input, CustomRequestHeaders customRequestHeaders)
        {
            return operations.BeginPurgeProtectionAsync(fabricName, protectionContainerName, input, customRequestHeaders, CancellationToken.None);
        }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public static LongRunningOperationResponse BeginUnconfigureProtection(this IProtectionContainerOperations operations, string fabricName, string protectionContainerName, UnconfigureProtectionInput input, CustomRequestHeaders customRequestHeaders)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IProtectionContainerOperations)s).BeginUnconfigureProtectionAsync(fabricName, protectionContainerName, input, customRequestHeaders);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public static Task<LongRunningOperationResponse> BeginUnconfigureProtectionAsync(this IProtectionContainerOperations operations, string fabricName, string protectionContainerName, UnconfigureProtectionInput input, CustomRequestHeaders customRequestHeaders)
        {
            return operations.BeginUnconfigureProtectionAsync(fabricName, protectionContainerName, input, customRequestHeaders, CancellationToken.None);
        }
        ...
        /// for protection container.
        /// </returns>
        public static ChangeProtectionStateResponse GetPurgeProtectionStatus(this IProtectionContainerOperations operations, string operationStatusLink)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IProtectionContainerOperations)s).GetPurgeProtectionStatusAsync(operationStatusLink);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// for protection container.
        /// </returns>
        public static Task<ChangeProtectionStateResponse> GetPurgeProtectionStatusAsync(this IProtectionContainerOperations operations, string operationStatusLink)
        {
        ...
        /// for protection container.
        /// </returns>
        public static ChangeProtectionStateResponse GetUnconfigureProtectionStatus(this IProtectionContainerOperations operations, string operationStatusLink)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IProtectionContainerOperations)s).GetUnconfigureProtectionStatusAsync(operationStatusLink);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// for protection container.
        /// </returns>
        public static Task<ChangeProtectionStateResponse> GetUnconfigureProtectionStatusAsync(this IProtectionContainerOperations operations, string operationStatusLink)
        {
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public static LongRunningOperationResponse PurgeProtection(this IProtectionContainerOperations operations, string fabricName, string protectionContainerName, PurgeProtectionInput input, CustomRequestHeaders customRequestHeaders)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IProtectionContainerOperations)s).PurgeProtectionAsync(fabricName, protectionContainerName, input, customRequestHeaders);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public static Task<LongRunningOperationResponse> PurgeProtectionAsync(this IProtectionContainerOperations operations, string fabricName, string protectionContainerName, PurgeProtectionInput input, CustomRequestHeaders customRequestHeaders)
        {
            return operations.PurgeProtectionAsync(fabricName, protectionContainerName, input, customRequestHeaders, CancellationToken.None);
        }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public static LongRunningOperationResponse UnconfigureProtection(this IProtectionContainerOperations operations, string fabricName, string protectionContainerName, UnconfigureProtectionInput input, CustomRequestHeaders customRequestHeaders)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IProtectionContainerOperations)s).UnconfigureProtectionAsync(fabricName, protectionContainerName, input, customRequestHeaders);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public static Task<LongRunningOperationResponse> UnconfigureProtectionAsync(this IProtectionContainerOperations operations, string fabricName, string protectionContainerName, UnconfigureProtectionInput input, CustomRequestHeaders customRequestHeaders)
        {
            return operations.UnconfigureProtectionAsync(fabricName, protectionContainerName, input, customRequestHeaders, CancellationToken.None);
        }
    }
}
