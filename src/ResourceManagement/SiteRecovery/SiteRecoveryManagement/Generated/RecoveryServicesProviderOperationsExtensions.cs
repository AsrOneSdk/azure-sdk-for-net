...
namespace Microsoft.Azure.Management.SiteRecovery
{
    public static partial class RecoveryServicesProviderOperationsExtensions
    {
        ...
        /// </returns>
        public static LongRunningOperationResponse BeginCreating(this IRecoveryServicesProviderOperations operations, string fabricName, string providerName, RecoveryServicesProviderCreationInput input, CustomRequestHeaders customRequestHeaders)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IRecoveryServicesProviderOperations)s).BeginCreatingAsync(fabricName, providerName, input, customRequestHeaders);
            }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public static Task<LongRunningOperationResponse> BeginCreatingAsync(this IRecoveryServicesProviderOperations operations, string fabricName, string providerName, RecoveryServicesProviderCreationInput input, CustomRequestHeaders customRequestHeaders)
        {
            return operations.BeginCreatingAsync(fabricName, providerName, input, customRequestHeaders, CancellationToken.None);
        }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public static LongRunningOperationResponse Create(this IRecoveryServicesProviderOperations operations, string fabricName, string providerName, RecoveryServicesProviderCreationInput input, CustomRequestHeaders customRequestHeaders)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IRecoveryServicesProviderOperations)s).CreateAsync(fabricName, providerName, input, customRequestHeaders);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// A standard service response for long running operations.
        /// </returns>
        public static Task<LongRunningOperationResponse> CreateAsync(this IRecoveryServicesProviderOperations operations, string fabricName, string providerName, RecoveryServicesProviderCreationInput input, CustomRequestHeaders customRequestHeaders)
        {
            return operations.CreateAsync(fabricName, providerName, input, customRequestHeaders, CancellationToken.None);
        }
        ...
        /// running operations.
        /// </returns>
        public static RecoveryServicesProviderOperationResponse GetCreateStatus(this IRecoveryServicesProviderOperations operations, string operationStatusLink)
        {
            return Task.Factory.StartNew((object s) => 
            {
                return ((IRecoveryServicesProviderOperations)s).GetCreateStatusAsync(operationStatusLink);
            }
            , operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
        }
        ...
        /// running operations.
        /// </returns>
        public static Task<RecoveryServicesProviderOperationResponse> GetCreateStatusAsync(this IRecoveryServicesProviderOperations operations, string operationStatusLink)
        {
