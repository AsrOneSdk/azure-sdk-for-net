...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery.Models
{
    ...
    public partial class FabricProperties
    {
        ...
        public FabricProperties(string friendlyName = default(string), EncryptionDetails encryptionDetails = default(EncryptionDetails), EncryptionDetails rolloverEncryptionDetails = default(EncryptionDetails), string internalIdentifier = default(string), string bcdrState = default(string), FabricSpecificDetails customDetails = default(FabricSpecificDetails), IList<HealthError> healthErrorDetails = default(IList<HealthError>), IList<HealthError> failoverHealthErrorDetails = default(IList<HealthError>), string health = default(string))
        {
            ...
            FailoverHealthErrorDetails = failoverHealthErrorDetails;
            Health = health;
            CustomInit();
        }
        ...
        /// <summary>
        /// Gets or sets failover health error details.
        /// </summary>
        [JsonProperty(PropertyName = "failoverHealthErrorDetails")]
        public IList<HealthError> FailoverHealthErrorDetails { get; set; }
