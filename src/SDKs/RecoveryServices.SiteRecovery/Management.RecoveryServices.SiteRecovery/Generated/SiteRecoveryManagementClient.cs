...
namespace Microsoft.Azure.Management.RecoveryServices.SiteRecovery
{
    ...
    public partial class SiteRecoveryManagementClient : ServiceClient<SiteRecoveryManagementClient>, ISiteRecoveryManagementClient, IAzureClient
    {
        ...
        private void Initialize()
        {
            ...
            SerializationSettings.Converters.Add(new PolymorphicSerializeJsonConverter<IdentityProviderInput>("instanceType"));
            DeserializationSettings.Converters.Add(new PolymorphicDeserializeJsonConverter<IdentityProviderInput>("instanceType"));
